      ...
      >
        ...
        <div className="bg-black/40 p-1 rounded-full flex items-center mb-8 border border-white/5 relative overflow-hidden">
          <button
            ...
            className={`flex-1 flex cursor-pointer items-center justify-center gap-2 py-2.5 text-sm font-medium rounded-full transition-all duration-300 relative z-10 ${paymentMethod === 'upi' ? 'text-white bg-linear-to-r from-gray-600/80 to-gray-500/80 shadow-sm' : 'text-slate-400 hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 flex cursor-pointer items-center justify-center gap-2 py-2.5 text-sm font-medium rounded-full transition-all duration-300 relative z-10 ${paymentMethod === 'paypal' ? 'text-white bg-linear-to-r from-gray-700/80 to-gray-600/80 shadow-sm' : 'text-slate-400 hover:text-white'
              }`}
          >
            PayPal
          </button>
