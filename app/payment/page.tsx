...
const PAYMENT_CONFIG = {
  ...
  suggestedAmount: '₹50.00 (One Chai)',
};
// =====================
...
const PremiumPaymentPage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#050608] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-blue-500/30">
      
      <Navbar />

      {/* Ambient Background Glows (optional, for extra premium feel) */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-900/10 blur-[100px] rounded-full pointer-events-none"></div>
      ...
      <div 
        className="relative w-full max-w-[420px] bg-[#0A0D12]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 text-center z-10"
        style={{
      ...
      >
        ...
        <div className="mb-6">
          ...
          <div className="mt-2 inline-block px-3 py-1 bg-white/5 rounded-full border border-white/5">
               <span className="text-slate-300 text-xs font-medium">Suggested: {PAYMENT_CONFIG.suggestedAmount}</span>
          </div>
        </div>
        ...
        <div className="bg-black/40 p-1 rounded-full flex items-center mb-8 border border-white/5 relative overflow-hidden">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-medium rounded-full transition-all duration-300 relative z-10 ${
              paymentMethod === 'upi' ? 'text-white bg-linear-to-r from-blue-600/80 to-blue-500/80 shadow-sm' : 'text-slate-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-medium rounded-full transition-all duration-300 relative z-10 ${
              paymentMethod === 'paypal' ? 'text-white bg-linear-to-r from-blue-700/80 to-blue-600/80 shadow-sm' : 'text-slate-400 hover:text-white'
            }`}
          >
             PayPal
          </button>
        ...
        <div className="min-h-[220px] flex items-center justify-center">
          ...
          {paymentMethod === 'upi' ? (
            ...
            <div className="w-full flex flex-col items-center animate-fadeIn">
              <div className="bg-white p-3 rounded-2xl shadow-lg shadow-blue-900/20 mb-5 ring-4 ring-white/5">
            ...
            // ---- PayPal View ----
             <div className="w-full flex flex-col items-center justify-center animate-fadeIn">
                 ...
                 <a 
                    ...
                    className="group relative overflow-hidden w-full max-w-[260px] flex items-center justify-center gap-3 bg-[#0070BA] hover:bg-[#005ea6] text-white py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-1"
                 >
        ...
        {/* <div className="mt-8">
          <button className="w-full bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-3.5 rounded-2xl font-medium text-base shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 transition-all duration-300 hover:-translate-y-0.5 active:scale-95">
            I've Sent the Support <Heart size={18} className="text-blue-200 fill-blue-200/30" />
          </button>
