          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="container  xl:max-w-[50%] items py-5 flex flex-col items-center gap-2.5">
              ...
              <button
                onClick={() => signIn("x")}
                type="button"
                className="text-zinc-100 hover:text-zinc-300 cursor-pointer border-[1px] focus:border-0 w-[100%]  focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2"
              >
                <svg
                  className="w-4 h-4 me-2"
                  aria-hidden="true"
